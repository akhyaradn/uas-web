<ul class="navbar-nav iq-main-menu"  id="sidebar">
    ...
    <li class="nav-item">
        ...
        <ul class="sub-nav collapse" id="sidebar-user" data-bs-parent="#sidebar">
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute(route('users.users'))}}" href="{{route('users.users')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
    ...
    <li class="nav-item static-item">
        <a class="nav-link static-item disabled" href="#" tabindex="-1">
            <span class="default-icon">Tour</span>
            <span class="mini-icon">-</span>
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link " data-bs-toggle="collapse" href="#sidebar-tour" role="button" aria-expanded="false" aria-controls="sidebar-tour">
            <i class="icon">
                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <ul class="sub-nav collapse" id="sidebar-tour" data-bs-parent="#sidebar">
            <li class="nav-item">
                <a class="nav-link {{activeRoute(route('tours.create'))}}" href="{{route('tours.create')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                    ...
                    <i class="sidenav-mini-icon"> E </i>
                    <span class="item-name">Tambah Tour</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{activeRoute(route('tours.tours'))}}" href="{{route('tours.tours')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                    ...
                    <i class="sidenav-mini-icon"> U </i>
                    <span class="item-name">Daftar Tour</span>
                </a>
            </li>
        </ul>
    </li>
